...
<head>
  <meta charset="UTF-8">
  <title>Pelayanan 24 Jam - RS Bersama</title>
  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="icon-box mb-4">
        ...
        <h2 class="section-title mb-3">Pelayanan 24 Jam</h2>
        <p class="lead">
          RS Bersama siap melayani Anda sepanjang waktu, termasuk layanan IGD, rawat inap, dan konsultasi dokter umum maupun spesialis. 
          Kami memiliki tim medis yang selalu siaga 24 jam untuk memberikan penanganan cepat dan tepat bagi setiap pasien yang membutuhkan pertolongan darurat maupun perawatan lanjutan.
        </p>
        <ul class="list-group list-group-flush text-start mt-4">
          <li class="list-group-item">✔️ Instalasi Gawat Darurat (IGD) 24 Jam</li>
          <li class="list-group-item">✔️ Rawat Inap & Rawat Jalan 24 Jam</li>
          <li class="list-group-item">✔️ Konsultasi dokter umum & spesialis setiap hari</li>
          <li class="list-group-item">✔️ Layanan farmasi & laboratorium nonstop</li>
        </ul>
      </div>
