...
<head>
  <meta charset="UTF-8">
  <title>Dokter Profesional - RS Bersama</title>
  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="icon-box mb-4">
        ...
        <h2 class="section-title mb-3">Dokter Profesional</h2>
        <p class="lead">
          RS Bersama memiliki tim dokter profesional dan berpengalaman di berbagai bidang spesialisasi. 
          Setiap dokter kami berkomitmen memberikan pelayanan terbaik, ramah, dan penuh empati kepada setiap pasien.
        </p>
        <ul class="list-group list-group-flush text-start mt-4">
          <li class="list-group-item">✔️ Dokter Spesialis Penyakit Dalam, Anak, Bedah, Kandungan, dan lainnya</li>
          <li class="list-group-item">✔️ Konsultasi dan pemeriksaan menyeluruh</li>
          <li class="list-group-item">✔️ Sertifikasi dan pelatihan medis terkini</li>
          <li class="list-group-item">✔️ Pendekatan humanis dan edukatif kepada pasien</li>
        </ul>
      </div>
